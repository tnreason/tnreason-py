...
class EntropyMaximizer:
    ...
    def alternating_optimization(self, sweepNum=10, updateKeys=None):
        ...
        for sweep in range(sweepNum):
            for optKey in updateKeys:
                ...
                self.formulaCores.update(encoding.create_formula_head(self.expressionsDict[optKey], headType="expFactor",
                                                                      weight=local_weight))
    ...
    def local_condition_satisfier(self, optKey, empRate):
        ...
        negValue, posValue = engine.contract(contractionMethod=self.contractionMethod,
