from tnreason.representation.formulas_to_cores import create_formula_computation_cores, \
    get_formula_color, \
    create_evidence_cores, create_atom_evidence_cores, create_expressionDict_computation_cores, \
    create_formulas_cores  # , create_formula_head
...
from tnreason.representation.creation_handling import create_trivial_core, create_basis_core, create_trivial_cores, \
    create_boolean_head, \
