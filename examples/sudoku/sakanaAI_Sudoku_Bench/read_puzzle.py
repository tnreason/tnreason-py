...
if __name__ == "__main__":
    ...
    df = pd.read_parquet('sample_data/challenge100.parquet')

    print(len(initial_board_into_evidence(df["initial_board"][0])))
    print(len(initial_board_into_evidence(df["solution"][0])))
