if __name__ == "__main__":
    ...
    dist = application.HybridKnowledgeBase(weightedFormulas={"w1": ["imp", "a", "b", 0.23]})
    ...
    sampler = eba.EnergyGibbsSampleCore(dist.get_energy_dict(), colors=dist.distributedVariables,
                                        ...
                                        # startSliceIterator=iter([(1, {"a" + representation.suf.disVarSuf: 1,
                                        #                 "b" + representation.suf.disVarSuf: 0})]),
