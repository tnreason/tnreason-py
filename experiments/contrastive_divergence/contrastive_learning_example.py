...
samples = knowledge.InferenceProvider(genKB).draw_samples(100, dfOutput=False)
...
learner.initialize_proposalDistribution(architecture, headNeuron,
                                        knowledge.MarkovNetwork({"samples": posDict}, coreType="PandasCore",
                                                                contractionMethod="CorewiseContractor"),
                                        alternationMethod="forwardSampling")
testDict = knowledge.MarkovNetwork({"samples": posDict})
