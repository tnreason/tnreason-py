...
def compute_evolution(startVector, inferer, evolNum=10, neighborInfluence=(2, 2)):
    ...
    for evolPos in range(1, evolNum):
        for cellPos in range(cellNumber):
            ...
            evolStates[evolPos, cellPos] = compute_state("n", valDict, inferer)["n" + aSuf]
    return evolStates
...
if __name__ == "__main__":
    ...
    assert compute_state("n", {"oldRight": 1, "m1": 0}, inferer)["n" + aSuf] == 0
    assert compute_state("n", {"oldRight": 1, "m1": 1}, inferer)["n" + aSuf] == 1
