from demonstrations.cellular_automata import structure as st
...
def get_ternary_inferer(ruleNumber):
    return get_equivalence_inferer([str(ruleNumber), "m1", "b", "p1"])
...
if __name__ == "__main__":
    basePath = "/Users/alexgoessmann/Documents/ENEXA/tnreason/version1/demonstrations/cellular_automata/example_plots/"
