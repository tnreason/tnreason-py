...
SUDOKU_NUM = 2
INITIAL_BOARD = "................"
CAGES = ((("r1c1", "r1c2"), 5), (("r2c1", "r2c2", "r3c2"), 8), (("r2c4", "r3c4"), 4))
NO_REPEAT_CAGES = ()
ARROWS = ()
EDGE_MARKERS = ()
LINES = ()
QUADRUPLES = ()
PARITY_CELLS = ()
LITTLE_KILLERS = ((("r2c4", "r3c3", "r4c2"), 8),)
INEQUALITIES = ()
ANTI_KNIGHT = False
...
def get_introduction_to_killer_sudoku_constraint_cores(num=SUDOKU_NUM, coreType=None):
    _check_num(num)
...
def get_assignment_as_constraint_network(
    ...
    return get_assignment_as_constraint_network_from_cores(
        num=num,
        constraint_cores=get_introduction_to_killer_sudoku_constraint_cores(
