...
EDGE_MARKERS = ()
LINES = (
    ("thermo", ("r8c7", "r9c6", "r9c5", "r9c4", "r8c3")),
    ("thermo", ("r6c5", "r5c5", "r4c5", "r3c5")),
)
QUADRUPLES = ()
PARITY_CELLS = ()
LITTLE_KILLERS = ()
...
def get_nostalgia_constraint_cores(num=SUDOKU_NUM, coreType=None):
    _check_num(num)
...
def get_assignment_as_constraint_network(
    ...
    return get_assignment_as_constraint_network_from_cores(
        num=num,
        constraint_cores=get_nostalgia_constraint_cores(num=num, coreType=coreType),
