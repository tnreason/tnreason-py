...
EDGE_MARKERS = ()
LINES = (
    ("balanced", ("r5c1", "r5c2", "r5c3", "r5c4")),
    ("balanced", ("r5c6", "r5c7", "r5c8", "r5c9")),
    ("balanced", ("r6c5", "r7c5", "r8c5", "r9c5")),
    ("balanced", ("r4c5", "r3c5", "r2c5", "r1c5")),
    ("balanced", ("r1c6", "r2c6", "r3c6", "r4c6")),
    ("balanced", ("r4c6", "r4c7", "r4c8", "r4c9")),
    ("balanced", ("r1c6", "r2c7", "r3c8", "r4c9")),
    ("balanced", ("r1c4", "r2c4", "r3c4", "r4c4")),
    ("balanced", ("r4c1", "r4c2", "r4c3", "r4c4")),
    ("balanced", ("r1c4", "r2c3", "r3c2", "r4c1")),
    ("balanced", ("r6c4", "r7c4", "r8c4", "r9c4")),
    ("balanced", ("r6c6", "r7c6", "r8c6", "r9c6")),
    ("balanced", ("r6c6", "r6c7", "r6c8", "r6c9")),
    ("balanced", ("r6c4", "r6c3", "r6c2", "r6c1")),
    ("balanced", ("r9c6", "r8c7", "r7c8", "r6c9")),
    ("balanced", ("r6c1", "r7c2", "r8c3", "r9c4")),
)
QUADRUPLES = ()
PARITY_CELLS = ()
LITTLE_KILLERS = ()
...
def get_four_triangles_constraint_cores(num=SUDOKU_NUM, coreType=None):
    _check_num(num)
...
def get_assignment_as_constraint_network(
    ...
    return get_assignment_as_constraint_network_from_cores(
        num=num,
        constraint_cores=get_four_triangles_constraint_cores(
