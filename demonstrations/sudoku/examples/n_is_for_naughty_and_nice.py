...
LINES = (
    ("region_sum", ("r1c3", "r1c4", "r2c5", "r3c6", "r2c7")),
    ("region_sum", ("r9c7", "r9c6", "r8c5", "r7c4", "r8c3")),
    (
        "region_sum",
        (
            "r3c3",
    ...
    ("whisper", ("r5c3", "r4c3", "r4c4", "r5c5", "r6c6", "r6c7", "r5c7")),
    ("whisper", ("r1c9", "r2c9")),
    ("whisper", ("r8c1", "r9c1")),
)
QUADRUPLES = ()
...
def get_n_is_for_naughty_and_nice_constraint_cores(num=SUDOKU_NUM, coreType=None):
    _check_num(num)
...
def get_assignment_as_constraint_network(
    ...
    return get_assignment_as_constraint_network_from_cores(
        num=num,
        constraint_cores=get_n_is_for_naughty_and_nice_constraint_cores(
