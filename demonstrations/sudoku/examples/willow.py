...
ARROWS = (("r5c1", ("r4c1", "r3c1", "r2c1")), ("r1c5", ("r1c4", "r1c3", "r1c2")))
EDGE_MARKERS = ()
LINES = (
    ("renban", ("r1c5", "r2c4", "r3c3", "r4c2", "r5c1")),
    ("renban", ("r5c2", "r5c3", "r5c4")),
    ("renban", ("r2c5", "r3c5", "r4c5")),
    ("renban", ("r9c6", "r9c7", "r9c8")),
    ("renban", ("r7c7", "r8c8")),
    ("whisper", ("r6c1", "r7c1", "r8c1")),
    ("whisper", ("r9c2", "r9c3", "r9c4")),
    ("whisper", ("r2c9", "r3c9", "r4c9")),
    ("whisper", ("r5c8", "r5c7", "r5c6")),
)
QUADRUPLES = ()
PARITY_CELLS = ()
LITTLE_KILLERS = ()
...
def get_willow_constraint_cores(num=SUDOKU_NUM, coreType=None):
    _check_num(num)
...
def get_assignment_as_constraint_network(
    ...
    return get_assignment_as_constraint_network_from_cores(
        num=num,
        constraint_cores=get_willow_constraint_cores(num=num, coreType=coreType),
