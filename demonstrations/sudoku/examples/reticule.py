...
CAGES = (
    (("r2c4", "r3c4", "r4c2", "r4c3", "r4c4"), 35),
    (("r6c2", "r6c3", "r6c4", "r7c4", "r8c4"), 26),
    (("r2c6", "r3c6", "r4c6", "r4c7", "r4c8"), 26),
    (("r6c6", "r6c7", "r6c8", "r7c6", "r8c6"), 18),
)
NO_REPEAT_CAGES = ()
ARROWS = ()
EDGE_MARKERS = ()
LINES = (
    ("thermo", ("r4c2", "r3c2", "r2c2", "r2c3", "r2c4")),
    ("thermo", ("r4c8", "r3c8", "r2c8", "r2c7", "r2c6")),
    ("thermo", ("r6c2", "r7c2", "r8c2", "r8c3", "r8c4")),
    ("thermo", ("r6c8", "r7c8", "r8c8", "r8c7", "r8c6")),
...
def get_reticule_constraint_cores(num=SUDOKU_NUM, coreType=None):
    _check_num(num)
...
def get_assignment_as_constraint_network(
    ...
    return get_assignment_as_constraint_network_from_cores(
        num=num,
        constraint_cores=get_reticule_constraint_cores(num=num, coreType=coreType),
